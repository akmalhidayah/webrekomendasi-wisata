...
<div class="card"><div class="card-header"><strong>Akses Cepat</strong></div><div class="card-body"><div class="row g-3"><div class="col-md-4"><a class="quick-link" href="{{ route('admin.wisata.create') }}"><i class="bi bi-plus-lg"></i>Tambah Wisata</a></div><div class="col-md-4"><a class="quick-link" href="{{ route('admin.rating-kunjungan.index', ['status' => 'pending']) }}"><i class="bi bi-chat-square-dots"></i>Validasi Rating</a></div><div class="col-md-4"><a class="quick-link" href="{{ route('admin.hasil-rekomendasi.index') }}"><i class="bi bi-bar-chart"></i>Hasil Rekomendasi</a></div></div></div></div>
@endsection
